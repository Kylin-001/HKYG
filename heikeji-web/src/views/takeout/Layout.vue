<template>
  <!-- ============================================
       ...
       品牌头部（红色主题）+ 功能标签导航 + 主内容区
       ============================================ -->
  <div class="min-h-screen">

    <!-- ====== 品牌头部区域（红色/暖色主题）====== -->
    <header class="relative overflow-hidden bg-gradient-to-r from-crimson via-crimson-light to-gold">
      <!-- 装饰性背景 -->
      ...
      <div class="relative z-10 max-w-screen-xl mx-auto px-4 lg:px-8 py-6 flex items-center justify-between">
        ...
        <div>
          ...
          <p class="text-white/70 text-sm mt-1">美味送达 · 足不出户</p>
        </div>
        ...
        <div class="flex items-center gap-1 overflow-x-auto scrollbar-hide -mb-px">
          <router-link
            ...
            <span
              ...
              class="absolute bottom-0 left-1/2 -translate-x-1/2 w-12 h-0.5 bg-crimson rounded-full"></span>
          </router-link>
        </div>
      </div>
    </nav>
