...
<template>
  <div class="max-w-4xl mx-auto space-y-6">
    ...
    <section class="relative overflow-hidden rounded-2xl border border-amber-100 bg-gradient-to-br from-amber-50/80 to-orange-50/50 p-6">
      <!-- 装饰背景 -->
      <div class="absolute top-0 right-0 w-48 h-48 bg-amber-100/50 rounded-full -translate-y-1/2 translate-x-1/4" />
      <div class="absolute bottom-0 left-0 w-32 h-32 bg-orange-100/30 rounded-full translate-y-1/2 -translate-x-1/4" />
    ...
    <section class="relative overflow-hidden bg-white rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50">
      <!-- 顶部装饰条 -->
      <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-500" />
      ...
      >
        ...
        <div class="space-y-3">
          <div
            v-for="(item, index) in dormitoryItems"
            :key="item.id"
          ...
          >
            ...
            <div class="text-right">
              <p
                ...
                :class="item.status === 'paid' ? 'text-emerald-600' : 'text-amber-600'"
              >
      ...
      <div class="relative">
        ...
        <ul class="text-sm text-amber-800/70 space-y-2">
          <li class="flex items-start gap-2">
            <span class="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 flex-shrink-0" />
