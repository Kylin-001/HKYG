<template>
  <!-- ============================================
       ...
       品牌头部（松绿色主题）+ 功能标签导航 + 主内容区
       ============================================ -->
  <div class="min-h-screen">

    <!-- ====== 品牌头部区域（松绿色主题）====== -->
    <header class="relative overflow-hidden bg-gradient-to-r from-pine-dark via-pine to-pine-light">
      <!-- 装饰性背景 -->
      ...
      <div class="relative z-10 max-w-screen-xl mx-auto px-4 lg:px-8 py-6 flex items-center justify-between">
        ...
        <div>
          ...
          <p class="text-white/70 text-sm mt-1">课表 · 图书馆 · 地图 · 成绩 · 教室 · 宿舍 · 食堂 · AI教学</p>
        </div>
        ...
        <div class="flex items-center gap-1 overflow-x-auto scrollbar-hide -mb-px">
          <router-link
            ...
            :class="[
              ...
              isTabActive(tab)
                ? 'text-pine font-semibold bg-pine/5'
            ...
            <span
              ...
              class="absolute bottom-0 left-1/2 -translate-x-1/2 w-12 h-0.5 bg-pine rounded-full"></span>
          </router-link>
        </div>
      </div>
    </nav>
...
// ============================================
const tabs = [
  { label: '课程表', path: '/campus/schedule', base: '/campus/schedule', icon: '\u{1F4C5}' },
  { label: '图书馆', path: '/campus/library', base: '/campus/library', icon: '\u{1F4DA}' },
  { label: '校园地图', path: '/campus/map', base: '/campus/map', icon: '\u{1F5FA}' },
  { label: '成绩查询', path: '/campus/grades', base: '/campus/grades', icon: '\u{1F3C6}' },
  { label: '教室查询', path: '/campus/classroom', base: '/campus/classroom', icon: '\u{1F3EB}' },
  { label: '宿舍服务', path: '/campus/dormitory', base: '/campus/dormitory', icon: '\u{1F3E0}' },
  { label: '校园食堂', path: '/campus/canteen', base: '/campus/canteen', icon: '\u{1F35C}' },
  { label: 'AI慕课', path: '/campus/ai-courses', base: '/campus/ai-courses', icon: '\u{1F916}' },
  { label: 'AI教学', path: '/campus/ai-teaching', base: '/campus/ai-teaching', icon: '\u{1F4BB}' },
]
