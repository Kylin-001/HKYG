...
export const useCommunityStore = defineStore('community', () => {
  ...
  return {
    boards, posts, currentPost, lostFoundList, activities,
    currentActivity, notifications, favorites, coupons,
    unreadCount, totalPosts, totalLF, totalActivities,
    loading, error,
    fetchBoards, fetchPosts, fetchPostDetail, createPost,
    toggleLikePost, addComment, fetchLostFound, publishLF,
    fetchActivities, fetchActivityDetail, joinActivity, leaveActivity, createActivity,
    fetchNotifications, markRead, fetchFavorites, removeFavorite,
    fetchCoupons, claimCoupon,
  }
})
