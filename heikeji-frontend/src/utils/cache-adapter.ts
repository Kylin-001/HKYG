...
class CacheAdapterFactory {
  private static adapters = new Map<string, new (options?: any) => ICacheAdapter>()

  // 注册适配器
  static register(name: string, adapter: new (options?: any) => ICacheAdapter): void {
...
export type { ICacheAdapter, CacheStats }
