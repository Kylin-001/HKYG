...
class LRUCache {
  ...
  private shouldEvict(newItemSize: number): boolean {
    return this.cache.size >= this.maxSize || this.currentMemory + newItemSize > this.maxMemory
  }
...
export { LRUCache, LFUCache, CacheStrategyManager, CacheWarmupManager, CacheMonitor }
