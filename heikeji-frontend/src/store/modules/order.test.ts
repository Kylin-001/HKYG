...
vi.mock('@/api/order', () => ({
  orderApi: {
    getOrderList: vi.fn(() => Promise.resolve({
      code: 20000,
      data: {
        records: [
          {
    ...
    getOrderDetail: vi.fn(() => Promise.resolve({
      code: 20000,
      data: {
        id: 1,
        orderNo: 'ORD001',
    ...
    shipOrder: vi.fn(() => Promise.resolve({
      code: 20000,
      data: { success: true }
    })),
    ...
    confirmReceive: vi.fn(() => Promise.resolve({
      code: 20000,
      data: { success: true }
    })),
    remindPay: vi.fn(() => Promise.resolve({
      code: 20000,
      data: { success: true }
    })),
    getLogisticsDetail: vi.fn(() => Promise.resolve({
      code: 20000,
      data: {
        company: '顺丰快递',
        trackingNo: 'SF123456789',
    ...
    agreeRefund: vi.fn(() => Promise.resolve({
      code: 20000,
      data: { success: true }
    })),
    rejectRefund: vi.fn(() => Promise.resolve({
      code: 20000,
      data: { success: true }
    })),
  },
