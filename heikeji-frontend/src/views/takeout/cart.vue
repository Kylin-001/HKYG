<template>
  <div class="cart-container">
            ...
            <template slot-scope="{ row }">
              <div class="product-info">
                ...
                <div class="product-details">
                  ...
                  <p v-if="row.specName" class="product-spec">{{ row.specName }}</p>
                  <p v-if="row.stock <= 10" class="stock-warning">
                    <i class="el-icon-warning"></i> 仅剩 {{ row.stock }} 份
                  </p>
                </div>
              </div>
            </template>
    ...
    <div v-else class="empty-cart">
      ...
      <h3>购物车空空如也</h3>
      <p>快去挑选心仪的美食吧</p>
      <el-button type="primary" @click="$router.push('/takeout/merchants')">
        <i class="el-icon-shop"></i> 去逛逛
      </el-button>
    </div>
    ...
    <div v-if="cartProducts.length > 0" class="checkout-bar">
      <div class="checkout-info">
        ...
        <div v-if="totalAmount < minOrderAmount" class="min-order-warning">
...
.cart-container {
  ...
  min-height: 100vh;
  padding-bottom: 100px; /* 为底部结算栏预留空间 */
}
