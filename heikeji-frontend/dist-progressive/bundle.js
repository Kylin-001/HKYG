...
***************************************************************************** */
        ...
        function renderSlot(name, fallbackRender, props, bindObject) {
          ...
          if (scopedSlotFn) {
            ...
            nodes =
              this.$slots[name] || (isFunction(fallbackRender) ? fallbackRender() : fallbackRender)
          }
        ...
        function watchPostEffect(effect, options) {
          return doWatch(effect, null, false ? undefined : { flush: 'post' })
        }
        function watchSyncEffect(effect, options) {
          return doWatch(effect, null, false ? undefined : { flush: 'sync' })
        }
        ...
        function defineAsyncComponent(source) {
          ...
          var loader = source.loader,
            ...
            {timeout} = source, // undefined = never times out
        ...
        function getRawBindingAttr(el, name) {
          return (
            el.rawAttrsMap[':' + name] || el.rawAttrsMap['v-bind:' + name] || el.rawAttrsMap[name]
          )
        }
        ...
        var parseStyleText = cached((cssText) => {
          var res = {}
          var listDelimiter = /;(?![^(]*\))/g
          ...
          // 2.6 v-slot syntax
          {
            if (el.tag === 'template') {
              ...
              if (slotBinding) {
                ...
                slotContainer_1.children = el.children.filter((c) => {
                  if (!c.slotScope) {
        ...
        function genHandlers(events, isNative) {
          ...
          if (dynamicHandlers) {
            return (
              prefix + '_d('.concat(staticHandlers, ',[').concat(dynamicHandlers.slice(0, -1), '])')
            )
          } else {
        ...
        var createCompiler = createCompilerCreator((template, options) => {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var update = add('591e54b2', content, false, {})
...
*/
  ...
  list.i = function (modules, mediaQuery, dedupe) {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var SimpleApp = __webpack_require__(14)
    ...
    /***/ function (module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ ;(function (global, process) {
        ...
        /* WEBPACK VAR INJECTION */
      }).call(this, __webpack_require__(0), __webpack_require__(7))
...
/***/ }),
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      'use strict'
      /* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleApp_vue_vue_type_style_index_0_id_0b8943cd_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(2)
      /* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleApp_vue_vue_type_style_index_0_id_0b8943cd_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default =
        /*#__PURE__*/ __webpack_require__.n(
          _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleApp_vue_vue_type_style_index_0_id_0b8943cd_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__
        )
...
/***/ }),
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      function fillParams(path, params, routeMsg) {
        ...
        try {
          var filler =
            regexpCompileCache[path] || (regexpCompileCache[path] = pathToRegexp_1.compile(path))
...
function createMatcher (
  ...
  router
      ...
      History.prototype.transitionTo = function transitionTo(location, onComplete, onAbort) {
        ...
        this.confirmTransition(
          ...
          () => {
            ...
            this$1$1.ensureURL()
            this$1$1.router.afterHooks.forEach((hook) => {
          ...
          (err) => {
            ...
            if (err && !this$1$1.ready) {
              ...
              if (!isNavigationFailure(err, NavigationFailureType.redirected) || prev !== START) {
                this$1$1.ready = true
                this$1$1.readyErrorCbs.forEach((cb) => {
                  cb(err)
                })
              }
            }
      ...
      function extractGuards(records, name, bind, reverse) {
        var guards = flatMapComponents(records, (def, instance, match, key) => {
      ...
      var HTML5History = /*@__PURE__*/ (function (History) {
        ...
        HTML5History.prototype.setupListeners = function setupListeners() {
          ...
          var handleRoutingEvent = function () {
            ...
            this$1$1.transitionTo(location, (route) => {
              if (supportsScroll) {
      ...
      var HashHistory = /*@__PURE__*/ (function (History) {
        ...
        HashHistory.prototype.setupListeners = function setupListeners() {
          ...
          var handleRoutingEvent = function () {
            ...
            this$1$1.transitionTo(getHash(), (route) => {
              if (supportsScroll) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0)))
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      // CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./src/SimpleApp.vue?vue&type=template&id=0b8943cd&scoped=true
    ...
    {_c} = _vm._self;
      ...
      var staticRenderFns = [
        function () {
          ...
          return _c(
            'div',
            {
              staticClass: 'simple-app',
            },
            [_c('h1', [_vm._v('Simple App Component')])]
          )
        },
      ]
      render._withStripped = true

      // CONCATENATED MODULE: ./src/SimpleApp.vue?vue&type=template&id=0b8943cd&scoped=true

      // CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./src/SimpleApp.vue?vue&type=script&lang=js
      /* harmony default export */ var SimpleAppvue_type_script_lang_js = {
        name: 'SimpleApp',
        data: function data() {
          return {
      ...
      // CONCATENATED MODULE: ./src/SimpleApp.vue?vue&type=script&lang=js
      /* harmony default export */ var src_SimpleAppvue_type_script_lang_js =
        SimpleAppvue_type_script_lang_js
      // EXTERNAL MODULE: ./src/SimpleApp.vue?vue&type=style&index=0&id=0b8943cd&prod&scoped=true&lang=css
      var SimpleAppvue_type_style_index_0_id_0b8943cd_prod_scoped_true_lang_css =
      ...
      // CONCATENATED MODULE: ./src/SimpleApp.vue

/* normalize component */

      var component = normalizeComponent(
        src_SimpleAppvue_type_script_lang_js,
        render,
        staticRenderFns,
        false,
        null,
      ...
      /* harmony default export */ var SimpleApp = (__webpack_exports__['default'] =
        component.exports)
