        ...
        output: {
          ...
          manualChunks: id => {
            ...
            if (id.includes('node_modules')) {
              ...
              // 工具库
              if (['axios', 'js-cookie', 'nprogress', 'dayjs', 'lodash-es'].includes(packageName)) {
                return 'utils-vendor'
              }
            ...
            if (id.includes('views/stats')) {
              return 'stats'
            }
            
            if (id.includes('views/app')) {
              return 'app'
            }
