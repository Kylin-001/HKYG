...
> **版本**: v1.2.0 | **状态**: Active | **分类**: API接口
> **创建日期**: 2024-05-30 | **最后更新**: 2026-04-05
> **维护者**: 黑科易购开发团队
...
| 版本 | 日期 | 变更内容 | 作者 |
|------|------|----------|------|
| v1.2.0 | 2026-04-05 | 统一格式，补充Phase 2新增API | AI助手 |
| v1.1.0 | 2026-03-16 | 补充营销/二手/失物招领/客服API | 开发团队 |
| v1.0.0 | 2024-05-30 | 初始版本，适配校园服务需求 | 开发团队 |
